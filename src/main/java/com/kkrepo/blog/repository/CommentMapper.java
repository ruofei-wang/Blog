...
public interface CommentMapper {
    ...
    @Select("SELECT c.content, c.name, c.article_id articleId FROM tb_article a, tb_comment c WHERE c.article_id IN ( SELECT id FROM tb_article ) AND a.state = #{articleState} order by c.id desc LIMIT #{limit};")
