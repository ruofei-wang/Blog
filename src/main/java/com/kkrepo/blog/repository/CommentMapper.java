...
public interface CommentMapper {
    ...
    @Select("select content,name,article_id articleId FROM tb_comment WHERE article_id in(select id from tb_article where state = #{articleState}) order by id desc limit #{limit};")
